...
import { cubicBezier, motion, useInView, type HTMLMotionProps } from "framer-motion"
import { cn } from "@/lib/utils"
import type { LandingAnimatedContainerProps } from "./landing-animated-container"
...
export function LandingMotionContainer({
  ...
  const isInView = useInView(ref, { margin: "50px", amount: 0.1, once })
