...
// Read language from <html lang> rather than useLanguage() so this still
// renders if the provider itself crashed.
      ...
      <div className="max-w-md w-full space-y-6 text-center">
        ...
        <div className="space-y-3">
          ...
          <p className="text-muted-foreground text-sm">
            {isAr ? "حدث خطأ غير متوقع. برجاء المحاولة مرة أخرى." : "We encountered an unexpected error. Please try again."}
          </p>
        </div>
        ...
        <Button onClick={reset} className="w-full h-12 rounded-lg gap-2">
